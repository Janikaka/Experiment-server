...
class ExclusionConstraints(WebUtils):
    ...
    def exclusionconstraints_GET(self):
        ...
        conf_id = self.request.matchdict['ckid']
    ...
    def exclusionconstraints_GET_one(self):
        ...
        app_id = self.request.matchdict['appid']
        conf_id = self.request.matchdict['ckid']
        exconst_id = self.request.matchdict['ecid']
    ...
    def exclusionconstraints_for_confkey_POST(self):
        app_id = self.request.matchdict['appid']
        first_config_id = self.request.matchdict['ckid']
        exconstraint = self.request.matchdict['exclusionconstraint']
